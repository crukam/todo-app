...
describe('controller', function () {
	...
	it('should highlight "All" filter by default', function () {
		// TODO: write test
		var todo={id:54,title:'my title',highlited:true};
		setUpModel([todo]);
		subject.setView('');
	...
	it('should highlight "Active" filter when switching to active view', function () {
		// TODO: write test
		var todo={id:234,title:'mytask',Active:true,highlited:true}
		setUpModel([todo]);
		subject.setView('');
		expect(view.render).toHaveBeenCalledWith('setFilter','');
	});
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			setUpModel([todo]);
			subject.setView('');
			expect(subject.toggleAll).toThrow();
		});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			// TODO: write test
			var todo={id:345,data:'my data'}
			setUpModel([todo]);
			subject.setView('');
			view.trigger('newTodo','my data');
			expect(model.read).toHaveBeenCalledWith(jasmine.any(Function));
            expect(model.create).toHaveBeenCalledWith('my data',jasmine.any(Function));
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			var todo = {id: 94, title: 'my todo'};
			setUpModel([todo]);

			subject.setView('');
			view.trigger('itemRemove',{id:94});
			expect(model.read).toHaveBeenCalledWith( jasmine.any(Function));
			expect(model.remove).toHaveBeenCalledWith(94, jasmine.any(Function));
		});
